...
Différences de gestion des images RGB-Color et Grayscale :
	RGB-Color:
		- mettre N = 3*longueurImg*largeurImg
		- Dans la fonction recupTabRGB : mettre tabRGB1[k+1] = g, tabRGB1[k+2] = b et idem pour tabRGB2 en dessous.
		- Dans la fonction recupTabRGB : remplacer k++ par k+=3;
	Grayscale:
		- mettre N = longueurImg*largeurImg
		- Dans la fonction recupTabRGB : enlever tabRGB1[k+1] = g, tabRGB1[k+2] = b et idem pour tabRGB2 en dessous.
		- Dans la fonction recupTabRGB : remplace k+=3 par k++;
